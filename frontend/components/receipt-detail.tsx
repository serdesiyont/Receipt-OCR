    ...
    <div className="fixed inset-0 bg-black/20 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4 flex justify-between items-center">
          <h2 className="text-2xl font-bold text-gray-900">{receipt.storeName}</h2>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-2 gap-6 mb-6">
            <div>
              ...
              <p className="text-lg font-semibold text-gray-900">{formatDate(receipt.purchaseDate)}</p>
            </div>
            <div>
          ...
          <div className="bg-gray-50 rounded-lg p-4 mb-6">
            ...
            <p className="text-3xl font-bold text-green-600">${receipt.totalAmount.toFixed(2)}</p>
          </div>
